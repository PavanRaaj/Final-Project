...
ActiveRecord::Schema.define(version: 20_220_816_082_938) do
  ...
  create_table 'contact_us_details', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    t.string 'name'
    t.string 'query'
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
  ...
  add_foreign_key 'payment_details', 'booking_details', column: 'booking_details_id', on_update: :cascade,
                                                        on_delete: :cascade
end
