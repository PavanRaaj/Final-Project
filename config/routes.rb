...
Rails.application.routes.draw do
  ...
  get 'admins/admin_power', to: 'admins#admin_power', as: :admin_power
  ...
  get 'homes/contact_us_page', to: 'homes#contact_us_page'
  ...
  match 'homes/contact_us_details', to: 'homes#contact_us_details', via: :post
