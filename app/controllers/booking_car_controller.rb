...
class BookingCarController < ApplicationController
 ...
 def array_returner
  ...
  def presence_value_returner
    ...
    def booking_detail
      current_user
      booking_detail = BookingDetail.new( pick_up_point: booking_params[:pick_up_point], pick_up_city: booking_params[:pick_up_city], pick_up_date: booking_params[:pick_up_date], pick_up_time: booking_params[:pick_up_time], end_date: booking_params[:end_date], end_time: booking_params[:end_time], users_id: current_user.id)
    ...
    def booking_params
        params.require(:booking_detail).permit(:pick_up_point, :pick_up_city, :pick_up_date, :pick_up_time, :end_date, :end_time)
    end
